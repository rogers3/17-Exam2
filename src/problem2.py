...
class Triangle(object):
    ...
    def area(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        s1 = ((self.a.x-self.b.x)**2+(self.a.y-self.b.y)**2)**(1/2)
        s2 = ((self.a.x-self.c.x)**2+(self.a.y-self.c.y)**2)**(1/2)
        s3 = ((self.c.x-self.b.x)**2+(self.c.y-self.b.y)**2)**(1/2)
        S = (1/2)*(s1+s2+s3)
    ...
    def return_doubled_triangle(self):
        ...
        #        They include the Example in the above doc-string.
        # -------------------------------------------------------------------------
        triangle2 = Triangle(self.a, self.b, self.c)
